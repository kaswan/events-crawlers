...
#    
#    post.post_metas.build(:meta_key => 'event_host', :meta_value => '999')
#    post.post_metas.build(:meta_key => '_event_host', :meta_value => 'field_99bfc186741fc')
...
#    # For male
#    age_range_for_male = self.age_range_for_male.gsub(/['才']/,'').split(/['〜']/)
#    age_range = []
...
#    end
#    # For female
#    age_range_for_female = self.age_range_for_female.gsub(/['才']/,'').split(/['〜']/)
#    age_range = []
